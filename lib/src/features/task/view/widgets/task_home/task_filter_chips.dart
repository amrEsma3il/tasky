    ...
    return Padding(
      ...
      child: Row(
        children: List.generate(
          ...
          (index) {
            List<Map<String, dynamic>> statusList = TaskRepo.statusList(context);
                ...
                return Container(
                  ...
                  child: FilterChip(
                    ...
                    label: Text(
                      ...
                      style: TextStyle(
                        fontSize: 16.sp,
                        fontWeight: state == index ? FontWeight.w700 : FontWeight.w400,
                        color: state == index ? Colors.white : AppColor.gray,
                      ),
                    ),
                    onSelected: (isSelected) {
                      ChangeStatusCubit.get(context).changeStatus(index);
                      TaskCubit.get(context).filterTasksByStatus(
                        (statusList[index]['status_name'] as String).toLowerCase(),
                        true,
                      );
                    },
